...
public class UserServiceIT {
	...
	private static final String DEFAULT_LOGIN = "quangthanh";

	private static final String DEFAULT_EMAIL = "quangthanh@localhost";

	private static final String DEFAULT_FULLNAME = "thanh";
	...
	void assertThatResetKeyMustNotBeOlderThan24Hours() {
		...
		Optional<User> maybeUser = userService.completePasswordReset("quangthanh2", user.getResetKey());
		assertThat(maybeUser).isNotPresent();
		userRepository.delete(user);
	}
